...
@section('content')
    <div class="video-w3l">
        ...
        <div class="agileinfo-grids" style="align-self: center; margin-bottom: 2%;">
            <div class="col-xs-3 col-sm-3 col-md-6 col-lg-6 offset-3">
            ...
            <div class="newsletter">
                ...
                <form action="{{ route('clients.store') }}" method="POST">
                    ...
                    <button class="btn1" data-toggle="tooltip" data-placement="bottom" title="Subscribe"><i class="fa fa-paper-plane" aria-hidden="true"></i></button>
                </form>
            </div>
            <!--//newsletter-->
